...
comments: true
image: /assets/img/shortcuts/ShortcutsDemo.png
---
...
![Shortcuts Demo](/assets/img/shortcuts/ShortcutsDemo.png)
...
![App Demo](/assets/img/shortcuts/AppDemo.png)
...
![NSUserActivityTypes](/assets/img/shortcuts/AddNSUserActivityTypesToPlist.png)
...
![NSUserActivityTypes](/assets/img/shortcuts/UserActivityDemo.png)
...
![IntentDefinitionFile](/assets/img/shortcuts/AddIntentDefinitionFile.png)

2) Create a new custom intent by clicking the `+` in the bottom left corner and give your intent a name.

![Intent](/assets/img/shortcuts/AddIntent.png)
...
![Configure Intent](/assets/img/shortcuts/ConfigureIntent.png)
...
![Enable Siri Capability](/assets/img/shortcuts/EnableSiriCapability.png)
...
![Add Intents Extension](/assets/img/shortcuts/AddIntentsExtension.png)
...
![Update Target Membership](/assets/img/shortcuts/UpdateIntentDefinitionFileTargetMemberships.png)
...
![Update Intents Extension Info Plist](/assets/img/shortcuts/UpdateIntentExtensionInfoPlist.png)
...
![Debug Intents Extension](/assets/img/shortcuts/DebugIntentsExtension.png)
