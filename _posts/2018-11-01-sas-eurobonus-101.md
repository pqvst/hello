...
### EuroBonus
EuroBonus is a Frequent Flyer Program (loyalty program) by SAS. As a EuroBonus member you earn points by flying with SAS and other partner airlines. You can also earn points by using a SAS branded credit card, booking cars, hotels, and more. You can then book flights using your points, which in general is very lucrative.

Being a EuroBonus is *completely* free. There are no hidden costs.


### Star Alliance (*A)
SAS is a member of Star Alliance. This means you can earn points and book award flights using other airlines than just SAS. For example: Singapore Airlines, Thai, ANA, Lufthansa, Swiss, United, Air Canada, and more. For full list of partners and terms refer to the partner [Earn](https://www.flysas.com/en/eurobonus/earn-points/) and [Spend](https://www.flysas.com/en/eurobonus/spend-points/) lists.


### Revenue / Award
In general, you can purchase flight ticket in two ways:
* Revenue - Flights booked paying cash (normal).
* Award - Flights booked using points.


### Travel Classes
There are 3 main [Travel Classes](https://www.flysas.com/en/fly-with-us/travel-classes/):
* Go - Economy
...
### Membership Levels
Your EuroBonus status determines the benefits you receive, such as upgrades, lounge access, business class check-in, free luggage, point bonuses, and more. There are 4 main [Membership Levels](https://www.flysas.com/en/eurobonus/membership-levels/):
* Member (EBB)
* Silver (EBS)
* Gold (EBG)
* Diamond (EBD)
...
* *Base Points* - Just determine your membership level (cannot be "spent").
...
> For example, a round-trip between Copenhagen to Tokyo in Go earns you 4.800 Base Points counting towards your next status level AND 4.800 Extra Points that you can spend as you wish.

Note that you do not earn any points for award flights.

### Qualification Period
You earn *Base Points* during your *Qualification Period* by flying. The *Qualification Period* is the 12 month period starting at the month that you signed up to EuroBonus.
...
### Base Points 
You earn *Base Points* by flying, and you always earn the same number of *Base Points* and *Extra Points* when flying. The number of points you earn depends on the destination and booking class. Typically the further you fly and the more you pay for your ticket the more you earn.
...
Your *Base Points* reset during the start of every *Qualification Period*. Therefore, your status is determined by how much you fly during each *Qualification Period*. Once you reach a new tier you can keep earning more *Base Points* to reach an even higher tier. Once you reach a new level you will keep that tier for the current **AND** following *Qualification Period*.
...
Your *Base Points* never decrease during a *Qualification Period* (they cannot be "spent") and spending *Extra Points* does not affect the number of *Base Points* that you have.
...
You can also spend your ™Extra Points* by bidding for upgrades using *Plusgrade*. The more you bid (using cash or points) the higher the chance is that you will receive an upgrade. Of course this also depends on how full the flight is.

Note that your *Extra Points* will expire after 4 years if not used. However, if you are a EuroBonus Diamond member then your points will never expire as long as you retain your membership level.


## Credit Cards
As shown above, credit cards are a great way to earn free *Extra Points* for every 100 kr that you spend. The number of points varies by card. There are also other benefits such as travel insurance, fraud protection, and award fare discounts (see *2-for-1 Vouchers* and *FlyPremium* below).
...
### SAS EuroBonus MasterCard
Earn *Extra Points* for every 100 kr you spend. The *Platinum* card also gives you a monthly 1.000 *Base Point* bonus and access to *Fly Premium*. Both cards offer a one-time welcome bonus of *Extra Points*.
...
### SAS EuroBonus Amex
Earn *Extra Points* for every 100 kr you spend. The *Elite* card also gives you a yearly 20.000 *Base Point* bonus giving you at least Silver status. All cards offer *2-for-1 Vouchers*. You also receive a large *Extra Points* welcome bonus when signing up for a card using a [referral](http://www.americanexpress.se/bjudin/philibCuV4?CPID=999999550).
...
## 2-for-1 Vouchers
You can earn *2-for-1 Vouchers* with Amex cards. This lets you book an SAS or Star Alliance award flight at half the price for up to 2 people (hence the name two-for-one).

* SAS Amex Elite - Voucher #1 at 150.000 kr, Voucher #2 at 300.000 kr
* SAS Amex Premium - Voucher at 150.000 kr
* SAS Amex Classic - Voucher at 100.000 kr
...
Example:
* London: X EB instead of X EB in Plus.
* New York: 60.000 EB instead of 80.000 EB in Plus.
* Tokyo: 60.000 EB instead of 100.000 EB in Business.
...
| You sign up for a SAS Amex Elite Card with a [referral](http://www.americanexpress.se/bjudin/philibCuV4?CPID=999999550) sign up bonus. The Elite card also gives you a yearly 20.000 Base Point bonus (enough for EuroBonus Silver). | +20.000 =20.000 | +18.000 =18.000 |
| You take a round-trip in Go to Tokyo | +4.800 =24.800 | +4.800 =22.800 |
| You take a round-trip in Plus to London | +3.000 =27.800 | +3.000 =25.800 |
| You use your SAS Amex Elite card for your monthly shopping and other purchases. Since you spent more than 150.000 SEK you get a 2-for-1 voucher | +0 =27.800 | +40.000 =65.800 |
| You book an award flight to Tokyo for 2 people using your 2-for-1 voucher (you do not earn points for award flights). | +0 27.800 | -60.000 =5.800 |
| Your qualification period ends on August 31, 2019, which resets your Base Points, but you of course keep your Extra Points. | -27.800 =0 | +0 =5.800 |
